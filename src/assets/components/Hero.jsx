...
import CV from "../../../public/files/Resume of Fardin Hasan Mayen.pdf";
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-start md:items-start space-y-4 z-10">
        {/* Hi, I'm */}
        <h1
          className={`text-3xl md:text-4xl font-semibold opacity-0  transform translate-y-6 ${
        ...
        {/* Name */}
        <h2
          className={`text-4xl md:text-4.5xl font-bold opacity-0 leading-[1.1] transform translate-y-6 ${
        ...
        <h3
          className={`text-2xl md:text-3xl font-semibold opacity-0 leading-[1.1] transform translate-y-6 ${
            animate ? "opacity-100 translate-y-0 transition-all duration-700 delay-600" : ""
          }`}
          style={{ marginBottom: "5px" }}
        >
          <span className="text-textCustom font-semibold">And I’m </span>
    ...
    onMouseLeave={(e) =>
      ...
      <div className="flex-1 mt-10 md:mt-0 flex justify-center md:justify-end z-10">
        <img
          ...
          className="w-64 h-64 md:w-80 md:h-80 rounded-full object-cover shadow-2xl hover:scale-105 transition-transform duration-500 animate-float"
        />
      </div>
    </section>
  );
